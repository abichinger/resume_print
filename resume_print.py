...
parser.add_argument('-l', '--log', type=pathlib.Path,
                    help="OctoPrint log file", required=True)
...
parser.add_argument('--lines', type=int,
                    help="use the last n lines of sent gcode to find the failure position", default=5)
